...
firebase_admin.initialize_app(cred,{'storageBucket': 'vkjcoin-4b5e0.appspot.com'})
db = firestore.client()
bucket = storage.bucket()

def generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open Beycoin App", web_app=WebAppInfo(url="https://vkjcoin.netlify.app/")))
    return keyboard
